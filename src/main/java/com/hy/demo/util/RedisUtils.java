...
public class RedisUtils {
     ...
     * @return
     */
    public Cursor<Map.Entry<Object, Object>> getSome(String key, Class cls) {
        redisTemplate.setHashValueSerializer(new Jackson2JsonRedisSerializer<>(cls));
        Cursor<Map.Entry<Object, Object>> scan = redisTemplate.boundHashOps(key).scan(ScanOptions.scanOptions().build());
        return scan;
    }
